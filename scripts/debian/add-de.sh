...
# Add others
sudo apt install -y picom dunst libnotify-bin libnotify-dev feh nitrogen rofi polybar scrot conky parcellite numlockx galculator galternatives papirus-icon-theme
