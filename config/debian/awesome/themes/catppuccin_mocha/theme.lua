...
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/catppuccin_mocha"
...
theme.titlebar_sticky_button_normal_active = theme.dir .. "/icons/titlebar/sticky_normak_active.png"
